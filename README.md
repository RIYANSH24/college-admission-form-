...
<body style="background-color: lightgoldenrodyellow;">
    <center> <form> <div>
        <header>  <h2>College Admission Form</h2> </header> 
        <br>
        ...
        <div>
            ...
            <select name="course" id="COURSE">
                <option style="color: aquamarine;"> SELECT AN OPTION </option>
            ...
            <br>
            <div>
                <a href="https://www.collegedekho.com/"> <img src="https://www-vantage-stg-publish.ets.org/content/dam/ets-org/brands/all-products/interior-third-college-dekho-logo.jpg" alt="TO VISIT OUR WEBSITE" height="90px"></a>
            </div>
        </div>
        <br>
        <br>
